...
<div class="bgimageaccueil px-4 py-5 text-center">
  <div class="py-5 pt-0">
    ...
    <div class="col-lg-6 mx-auto ">
      <p class="fs-3 mb-5 text-beige">Pomme cannelle, c'est avant tout un concept associant la pâtisserie traditionnelle et la restauration, dans une ambiance sympa et décontractée.</p>
